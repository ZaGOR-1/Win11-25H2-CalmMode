...
> Статус (2026-06-20): `VERSION = 2.5` **зарелізено** (тег `v2.5` запушено). Зроблено 5A.
> Гейти зелені — parse (рушій + GUI), PSScriptAnalyzer CLEAN, Pester **38/38**, Audit `EXIT=0`,
> forbidden patterns відсутні. Лишилось **5B + 5C**.
...
4. **5B (5.4, 5.5)** — нові параметри запуску; обовʼязково тести. ← наступне
